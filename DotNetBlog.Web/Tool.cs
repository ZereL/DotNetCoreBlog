...
namespace DotNetBlog.Web
{
    public static class Tool
    {
        ...
        {
            //删除脚本   
            Htmlstring = Regex.Replace(Htmlstring, @"<script{FNXX==XXFN}*?>.*?</script>", "", RegexOptions.IgnoreCase);
            //删除HTML   
            Htmlstring = Regex.Replace(Htmlstring, @"<(.{FNXX==XXFN}*)>", "", RegexOptions.IgnoreCase);
